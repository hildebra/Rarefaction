...
// rcpp_rarefaction
List rcpp_rarefaction(Rcpp::String input, NumericMatrix rMatrix, StringVector inColNames, StringVector inRowNames, int repeats, long depth, int NoOfMatrices, bool verbose, unsigned int threads, int margin);
RcppExport SEXP rarefaction_rcpp_rarefaction(SEXP inputSEXP, SEXP rMatrixSEXP, SEXP inColNamesSEXP, SEXP inRowNamesSEXP, SEXP repeatsSEXP, SEXP depthSEXP, SEXP NoOfMatricesSEXP, SEXP verboseSEXP, SEXP threadsSEXP, SEXP marginSEXP) {
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(rcpp_rarefaction(input, rMatrix, inColNames, inRowNames, repeats, depth, NoOfMatrices, verbose, threads, margin));
    return __result;
END_RCPP
}
